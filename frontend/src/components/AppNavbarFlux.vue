<template>
  <nav class="flux-navbar sticky top-0 z-50">
    <div class="h-16 flex items-center px-6 gap-6">
      ...
      <!-- Chat (mobile) -->
      <RouterLink v-if="chatEnabled" to="/chat" class="lg:hidden relative w-9 h-9 flex items-center justify-center rounded-xl flux-icon-btn shrink-0" aria-label="Chat" @click="mobileMenuOpen = false">
