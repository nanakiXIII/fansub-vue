  ...
  <div class="relative shrink-0" ref="rootRef">
    ...
    <Teleport to="body">
      <Transition name="share-drop">
        <div v-if="open" ref="dropdownRef" class="share-dropdown w-52 bg-bg-1 border border-white/[0.1] rounded-xl shadow-2xl overflow-hidden z-30" :style="dropdownStyle">
